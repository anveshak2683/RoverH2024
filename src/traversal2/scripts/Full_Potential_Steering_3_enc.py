...
class Drive:
    def __init__(self):
        ...
        rospy.Subscriber("enc_arm", Float32MultiArray, self.single_enc)
    ...
    def single_enc(self,msg):
        if self.single_initial== False:
            self.enc_data[2] = msg.data[2]*90/2550
            self.initial_enc_data[2]= msg.data[2] * 90/2550
            self.single_initial= True
        else:
            self.enc_data[2] = msg.data[2]*90/2550 - self.initial_enc_data[2]
