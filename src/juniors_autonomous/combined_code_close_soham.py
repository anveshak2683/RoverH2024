...
#================This is the rot-in-place code for frequency checking of opencv using cropped template===========================
            ...
            if (
                ...
                if self.cvcounter<10:
                    if self.distance < 1.5 and not self.searchcalled:
                        ...
                        print(f"I got my direction as {direction} at {self.cvcounter}")
                        print(f"%%%%%%%%%% LEFT ARROW DETECTED: {self.arrow_left} and RIGHT ARROW DETECTED: {self.arrow_right} &&&&&&&&&&&&")
                        if ret == True:
                            self.ret = ret
                    ...
                    print("I am in ELSE CVCOUNTERRRRRRRRR")
                    if self.ret:
