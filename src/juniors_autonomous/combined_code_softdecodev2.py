...
class ZedDepth:
    def __init__(self):
        ...
        self.templatel = cv.imread('arrow_template_left_crop1.jpg', cv.IMREAD_GRAYSCALE)
        self.templater = cv.imread('arrow_template_right_crop1.jpg',cv.IMREAD_GRAYSCALE)
        ...
        self.time_thresh = 20 #Duration between search
        ...
        self.arrows=["left","right","left","right"]
        ...
        if self.init or self.searchcalled:
            ...
            if abs(self.distance)> self.circle_dist:
                ...
                if(self.arrow_numbers == self.count_arrow):
                    ...
                    lat_av= lat_sum/100
                    lon_av = lon_sum/100
                    with open("sparsh4.csv", "a", newline="") as csv_file:
                ...
                if self.direction == "Not Available":
                    ...
                    if self.count_arrow <= self.arrow_numbers:
                        ...
                        file_object.close()
                        with open("sparsh3.csv", "a", newline="") as csv_file:
                            csv_writer = csv.writer(csv_file)
                            csv_writer.writerow([lat_av, lon_av])
                            self.gpscalled = 0
                            print()
...
#            return
        ...
        if (
            ...
            if self.distance > 0.0 and self.distance < 10.0:  # change
        ...
        if (
            ...
            if (
                ...
                if self.distance < 1.5 and not self.searchcalled:
                    ...
                    if ret:
                        self.direction=self.arrows[self.count_arrow]
                        self.ret=True
