...
class receiver():
    ...
    def on_update(self,frame):
        ...
        if frame.msg_id == 0:
            ...
            if self.counter==0:
                self.counter+=1
                self.frame=self.sender.setstage_frame(2)
                self.ser.write(self.frame)
                self.frame=self.sender.navigation_to_gps_frame(39.88409, 32.77748)
                self.ser.write(self.frame)
                ...
                self.counter+=1
                self.frame=self.sender.setstage_frame(3)
                self.ser.write(self.frame)
                self.frame=self.sender.navigation_to_gps_frame(0.0003,0.0003)
                self.ser.write(self.frame)
