...
class tube_detector:
    def __init__(self):
        ...
        self.vel_pub = rospy.Publisher('arm_goal', Float32MultiArray, queue_size = 10)
...
#        self.ik_start=True
    ...
    def Depth(self,data):
        ...
        print(f"Depth: {self.memory_depth}")
    ...
    def show_coordinates(self,p_x,p_y,cv_image):
        ...
        self.cord_x=self.memory_depth*(p_x-c_x)/f_x
        self.cord_y=self.memory_depth*(p_y-c_y)/f_y
        self.cord_z=self.memory_depth
        ...
        if(self.image_arrived == True):
            ...
            if self.p_x is not None and self.p_y is not None:
                ...
                if (self.main_control == True):
                    ...
                    msg.data = [0,0,0]            
                    msg.data[1] = self.cord_z - 0.115 #offset for zed camera
...
#                    if msg.data[0]!=0 and msg.data[1]!=0 and self.ik_start:
    ...
    def tube_frame(self,x,y,z):
        ...
        trans = (0,0,0)
        br.sendTransform((x,y,z), (0,0,0,1), rospy.Time.now(), "sample_tube", "zed2i_left_camera_optical_frame")
