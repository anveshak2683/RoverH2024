...
def mask_red(frame):
    ...
    #for red
    lowerLimit1 = np.array([0, 150, 100])
    upperLimit1 = np.array([15, 255, 175])
 #   lowerLimit2 = np.array([230, 200, 100])
#    upperLimit2 = np.array([255, 255,200])
